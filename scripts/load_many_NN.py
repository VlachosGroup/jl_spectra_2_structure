...
#cv_folder = r'C:\Users\lansf\Box Sync\Synced_Files\Coding\Python\Github\jl_spectra_2_structure\scripts\cross_validation_CO_combine_hollow_sites_low'
cv_folder = r'C:\Users\lansf\Box Sync\Synced_Files\Coding\Python\Github\jl_spectra_2_structure\scripts\cross_validation_CO_GCN_high'
...
CV_class.plot_parity_plots(figure_directory='show',model_list=[0,1,2])

CV_class.plot_parity_plots(figure_directory='show',model_list=[0,1,2],use_ensemble=True)