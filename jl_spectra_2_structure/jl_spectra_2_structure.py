...
class IR_GEN:
    ...
    def _get_probabilities(self, num_samples, NUM_TARGETS):
        ...
        probabilities : numpy.ndarray of size (num_samples, NUM_TARGETS)
        	The probabilities to select each binding-type or GCN fgroup.
        """
    ...
    def _mixed_lineshape(self, FWHM, fL, ENERGY_POINTS, energy_spacing):
        """
        Accepts a full-width-half-maximum, a fraction of Lorentian, energy spacing
        and number of points and produces the transform with wich the spectra is
